...
class VodPackage(object):
    ...
    def __init__(self, xml_path, vod_config=None):
        ...
        self.has_box_cover = "box_cover" in self.D_ams
    ...
    def write_xml(self, rewrite=False):
        ...
        # Asset elements
        for ae_type in ("movie", "preview", "poster", "box_cover"):
    ...
    def check_files(self):
        for ae_type, ae_name in self.D_content.items():
            ...
            # content files
            if (ae_type == "poster") or (ae_type == "box_cover"):
