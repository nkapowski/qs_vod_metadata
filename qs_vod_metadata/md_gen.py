...
def generate_metadata(
    ...
    # and a poster / box_cover with a suitable extension.
    ...
    has_box_cover = _set_ae(
        vod_package, movie_name, "box_cover", IMAGE_EXTENSIONS
    )
    ...
    if has_box_cover:
        ...
        vod_package.D_ams["box_cover"].update(
            {
                "Provider":  vod_config.provider,
                "Product": vod_config.product,
        ...
        vod_package.D_app["box_cover"].update({"Type": "box_cover"})
